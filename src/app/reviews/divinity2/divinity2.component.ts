  ...
  template: `
	...
	<div class="review-detail">
		...
		<div class="review-intro">	
			ocos juegos tienen la profundidad que posee Divinity: Original Sin II. Aunque al inicio un tanto sobrepasada, las muchas horas de juego que conlleva terminar esta obra de arte dan pie a masterizar muchos de sus elementos y disfrutar de la creatividad de los desarrolladores y, sobre todo, de la propia. 
			<br><br>
		</div>
		<div class="review-paragraph">
			En una primera partida, es inabarcable explotar al máximo todas las herramientas que el jugador es responsable de evaluar, seleccionar y emplear a su antojo. En conjunto con las numerosas misiones secundarias y decisiones sin tomar, convierten el título en completamente rejugable.
			<br><br>
		</div>
		<div class="review-quote-left">
			4 personajes con sus historias y problemas
		</div>
		<div class="review-paragraph">
			A esta tremenda hipótesis se le suma el componente que más engancha: el multijugador; poder vivir la aventura cooperando con hasta 3 amigos, codo a codo en el combate, las conversaciones y debatiendo estratégicamente la especialización y equipamiento de cada personaje para que sean complementarios y no quede situación que nadie sea proclive a resolver. Cada uno controlará a uno o más personajes de los 4 que elegiremos con sus propias historias y problemas previos que resolver a parte de la trama principal.
			<br><br>
		...
		<div class="review-quote-right">
			Escenarios variados llenos de misterios
		</div>
		<div class="review-paragraph">
		...
		<div class="review-conclusion">
			Divinity: Original Sin 2 es una creación muy ambiciosa, libre y que nunca te deja de sorprender. Capaz de mantener la inquietud del jugador hasta el fin en situaciones de tensión, estrategia e incertidumbre. Una joya para quien sepa apreciarla.
		</div>
	</div>
  `,
  styles: [
