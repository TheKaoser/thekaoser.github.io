	...
	template: `
		...
		<div class="review-detail">
			...
			<div class="review-paragraph is-italic">
				ew World, el reciente MMORPG de Amazon Games, fue concebido como una idea tremendamente ambiciosa: Un mundo persistente que se desarrollaría a través de la intervención simultánea de miles de jugadores batallando por sus territorios, construyendo ciudades, y contribuyendo a sistemas económicos. Con unos gráficos más que decentes y un apartado sonoro excelente, se lanzó al desafío de los MMORPGs.
				<br><br>
			</div>
			<img class="review-image-center" src="assets/imgs/NW/PVE.png">
			<div class="review-paragraph is-italic">
				<br>
			...
			<div class="review-quote-right is-bold">
				Las acciones simples del jugador contribuyen a un todo mucho mayor
			</div>
			<div class="review-paragraph is-italic">
			...
			<img class="review-image-center" src="assets/imgs/NW/Map.png">
			<div class="review-paragraph is-italic">
				<br>
			...
			<div class="review-quote-left is-bold">
				Es necesario viajar entre territorios constantemente
			</div>
			<div class="review-paragraph is-italic">
			...
			<img class="review-image-center" src="assets/imgs/NW/Regions.jpg">
			<div class="review-paragraph is-italic">
				<br>
