...
@Component({
	...
	template: `
		...
		<div class="review-detail">
			...
			<img class="review-image" src="assets/imgs/NW/PVE.png">
			<div class="review-paragraph">
				<br>
			...
			<img class="review-image" src="assets/imgs/NW/Map.png">
			<div class="review-paragraph">
				<br>
			...
			<img class="review-image" src="assets/imgs/NW/Regions.jpg">
			<div class="review-paragraph">
				<br>
