...
@Component({
  ...
  template: `
	...
	<div class="review-detail">
		...
		<img class="review-image" src="assets/imgs/TESO/Summerset.jpg">
		...
		<img class="review-image" src="assets/imgs/TESO/Dungeon.jpg">
		<div class="review-paragraph">
			<br>
		...
		<img class="review-image" src="assets/imgs/TESO/Boss.jpg">
		<div class="review-paragraph">
			<br>
